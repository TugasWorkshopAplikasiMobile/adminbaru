            ...
            <div class="active tab-pane" id="activity">
                <form class="form-horizontal">
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" ID_SISWA" name="id" readonly>
                      <!-- <label for="inputid" class="col-sm-2 control-label"> ID_SISWA; ?></label> -->
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" NAMA_SISWA" name="id" readonly>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" NAMA_PANGGILAN" name="id" readonly>
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" TTL_SISWA" name="id" readonly>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" USIA_1JULI" name="id" readonly>
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Jenis Kelamin</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" JK_SISWA" name="id" readonly>
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" AGAMA_SISWA" name="id" readonly>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" KEWARGANEGARAAN" name="id" readonly>
                  ...
                  <label for="TinggalBersama" class="col-sm-2 control-label">Tinggal Bersama</label>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" TINGGAL_BERSAMA" name="id" readonly>
                  ...
                  <a href="http://localhost/kuliah/jann/siswa/siswasekretaris/sissmp" type="button" class="btn btn-primary pull-center">Kembali</a>
                </form>
                <!-- Post -->
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" NAMA_AYAH" name="id" readonly>
                  </div>
                  </div>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" NAMA_IBU" name="id" readonly>
                      <!-- <label class="col-sm-2 control-label"> USIA_1JULI; ?></label> -->
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Aama Ayah</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" AGAMA_AYAH" name="id" readonly>
                      <!-- <label class="col-sm-2 control-label"> JK_SISWA; ?></label> -->
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" AGAMA_IBU" name="id" readonly>
                      <!-- <label class="col-sm-2 control-label"> AGAMA_SISWA; ?></label> -->
                    </div>
                  </div>
                   ...
                   <div class="col-sm-10">
                      <input type="text" class="form-control" id="id" value=" TGL_LAHIR_AYAH" name="id" readonly>
                      <!-- <label class="col-sm-2 control-label"> KEWARGANEGARAAN; ?></label> -->
                    </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" TGL_LAHIR_IBU" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" PEND_TERAKHIR_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" JUR_YG_DIAMBIL_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" JUR_YG_DIAMBIL_IBU" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" NAMA_INSTANSI_AYAH_BEKERJA" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" NAMA_INSTANSI_IBU_BEKERJA" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" PANGKAT_GOL_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" PENGHASILAN_PERBULAN_IBU" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" JUMLAH_TANGGUNGAN_IBU" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" ALAMAT_RMH_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" ALAMAT_KANTOR_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" TLP_RMH_HP_AYAH" name="id" readonly>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="id" value=" TLP_KANTOR_IBU" name="id" readonly>
                  </div>
                  </div>
...
<!-- /////////////////////////////////// NANTI DITAMBAHI RIWAYAT SEKOLAH KARENA MELALUI TK DAN SD //////////////////////////////////////// -->
