...
<div class="box box-primary">
          <form method="post" action="<?php echo base_url('nilai/nilai/prosesupdatesd') ?>">
            <!-- /.box-header -->
            <!-- form start -->
          ...
          <!-- /.box -->
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('nilai/nilai/nisd'); ?>" type="button" class="btn btn-primary">Batal</a>
